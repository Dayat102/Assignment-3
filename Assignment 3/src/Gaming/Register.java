...
public class Register extends JFrame {
	...
	public Register() {
		...
		cabProveID.setBounds(100, 205, 129, 20);
		panel_1_1.add(cabProveID);
		
		JLabel lblNewLabel_1_1_1_1_1 = new JLabel("Payment Method");
		lblNewLabel_1_1_1_1_1.setFont(new Font("Tahoma", Font.BOLD, 11));
		lblNewLabel_1_1_1_1_1.setBounds(20, 232, 62, 14);
		panel_1_1.add(lblNewLabel_1_1_1_1_1);
		
		JComboBox cabProveID_1 = new JComboBox();
		cabProveID_1.setModel(new DefaultComboBoxModel(new String[] {"Make a Selection", "Credit Card", "Cash"}));
		cabProveID_1.setFont(new Font("Tahoma", Font.BOLD, 11));
		cabProveID_1.setBounds(100, 229, 129, 20);
		panel_1_1.add(cabProveID_1);
		...
		btnReset.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				cabProveID_1.setSelectedItem("Make a selection"); 
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Ref Num", "First Name", "Surname", "Address", "Postcode", "Telephone", "Date_Reg", "Prove ID","Payment Method"
			}
		));
